...
export default function Video() {
    ...
    return(
        <div className="py-20 px-10 md:px-20 mt-20 md:mb-12 bg-slate-800">
            <div className="container mx-auto items-center flex-wrap flex md:flex-nowrap justify-center">
                ...
                <div className="mt-12 md:mt-0 md:ml-12 md:p-8">
                    ...
                    <a href="#" className="inline-flex items-center px-4 py-3 text-lg font-medium text-center text-white rounded-lg bg-fuchsia-600 hover:bg-fuchsia-700 focus:ring-4 focus:outline-none focus:ring-blue-300">
                        COMECE AGORA
                    </a>
                </div>
            </div>
