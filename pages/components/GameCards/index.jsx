                ...
                {data.map(x => (
                    <div key={x.title} className="bg-white mb-8 md:mb-0 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 ml-2 mr-2">
                        ...
                        <div className="p-5">
                            ...
                            <a href="#" className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-green-true hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-green-true dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                Saiba mais
